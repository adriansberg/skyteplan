...
- [ ] **UX-01**: Fixed bottom tab bar replaces top navigation; tabs: Skyteplan / Skyttere / Premieliste; 56px height + `env(safe-area-inset-bottom)` for iOS; touch targets ≥ 44px
